        ...
        <div class="card-body p-4">
            ...
            <form class="row g-3" method="POST" action="{{ route('user.store') }}">
                ...
                <div class="col-md-12">
                    ...
                    <div class="position-relative input-icon">
                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="input16" placeholder="Email" required>
                ...
                <div class="col-md-12">
                    <div class="d-md-flex d-grid align-items-center gap-3 justify-content-end">
                        ...
                        <a href="{{route('user.index')}}" class="btn btn-inverse-dark px-4">Back</a>
                    </div>
                </div>
            </form>
        </div>
