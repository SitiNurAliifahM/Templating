            ...
            <form class="row g-3" method="POST" action="{{ route('kategori.update', $kategori->id) }}">
                ...
                <div class="col-md-4x">
                    ...
                    <div class="position-relative input-icon">
                        <input type="text" name="name_category" class="form-control @error('name_category') is-invalid @enderror" id="input13" value="{{ $kategori->name_category }}" placeholder="Category" required>
