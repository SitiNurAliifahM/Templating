                        ...
                        <div class="cat-menu__category p-relative">
                            ...
                            <div class="category-menu category-menu-off">
                                <ul class="cat-menu__list">
                                    ...
                                    <li><a href="{{ url('shop') }}"><i class="fal fa-shoe-prints"></i> Gift Sets</a>
                                    </li>
                                    <li><a href="{{ url('shop') }}"><i class="fal fa-smile"></i> Plastic Gifts</a>
                                    </li>
                                    <li><a href="{{ url('shop') }}"><i class="fal fa-futbol"></i> Handy Cream</a>
                                    </li>
                                        ...
                                        <ul class="submenu mega-menu">
                                            <li>
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="{{ url('shop_details') }}">Shop sidebar</a></li>
